...
**Tab 1 — General:** LANGUAGE (segmented RU/RU+EN/EN/AUTO, default RU+EN) · INSERTION (Insert toggle, Trim whitespace, Normalize terminology, Paste method) · MICROPHONE (device select + inline permission hint row).
